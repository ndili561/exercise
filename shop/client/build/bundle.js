...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var IconBase = __webpack_require__(226);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Items = React.createClass({
	  ...
	  handleClick: function handleClick(e) {
	    this.setState({ items: this.props }, function () {
	      this.handleState();
	    });
	  },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'box' },
	        React.createElement('img', { src: 'images/' + this.props.img, className: 'show-image' }),
	        React.createElement(
	          'h4',
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(ShoppingBasket, { className: 'icon', icon: this.icon })
	          )
	        )
	      )
	    );
